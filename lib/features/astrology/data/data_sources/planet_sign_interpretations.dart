...
class PlanetSignInterpretations {
  ...
  static String _getDefaultInterpretation(Planet planet, ZodiacSign sign) {
    // TODO(i18n): os templates abaixo (vindos da main, cobrindo os pontos
    // místicos novos) ainda são PT-only — localizar junto com os interpreters
    // (magical_interpreter/transit_interpreter).
