...
/// Os 12 signos do zodíaco — conteúdo em português (idioma-base).
///
/// O campo `sign` é invariante entre idiomas; apenas os textos são traduzidos.
/// Mantenha a mesma ordem/contagem nos três arquivos
/// (`zodiac_signs_data_pt/en/es.dart`) — a paridade é verificada em
/// `test/astrology_content_parity_test.dart`.
const List<ZodiacSignData> zodiacSignsPt = [
  ZodiacSignData(
