...
const LearningTrail magiaBrancaTrailPt = LearningTrail(
    ...
    lessons: [
      ...
      TrailLesson(
        ...
        practice:
            'Nesta prática você vai treinar presença diante do fogo. Primeiro, prepare um lugar seguro e acenda uma vela branca. Depois, durante dez minutos, apenas observe a chama — o movimento, a cor, a dança — sem pedir absolutamente nada. Por fim, apague com gratidão ou deixe queimar em segurança. O objetivo é construir intimidade com a ferramenta antes de usá-la: quem sabe contemplar a chama aprende a focar a própria intenção. Aproveite para conhecer a cor escolhida: abra a enciclopédia de Cores pelo atalho abaixo e explore a página dela',
