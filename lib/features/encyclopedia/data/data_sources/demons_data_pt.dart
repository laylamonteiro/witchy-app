...
/// Demônios da Enciclopédia — conteúdo em português (idioma-base).
///
/// Abordagem informativa e histórica: goécia, folclore, demonologia literária
/// e releituras modernas, sem incentivo a práticas de dano. Emojis são
/// invariantes; mantenha a mesma ordem nos três arquivos
/// (`demons_data_pt/en/es.dart`) — a paridade é verificada em
/// `test/content_parity_test.dart`.
const List<ArcaneEntry> demonsPt = [
  ArcaneEntry(
    name: 'Lilith',
    emoji: '🌒',
