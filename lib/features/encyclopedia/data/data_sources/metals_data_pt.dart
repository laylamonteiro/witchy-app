...
/// Metais da enciclopédia — conteúdo em português (idioma-base).
///
/// Enums, elementos, planetas e imagens são invariantes entre idiomas.
/// Mantenha a mesma ordem nos três arquivos (`metals_data_pt/en/es.dart`) —
/// a paridade é verificada em `test/content_parity_test.dart`.
final List<MetalModel> metalsPt = [
  const MetalModel(
    name: 'Ouro',
    description:
