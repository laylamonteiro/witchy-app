...
/// Cristais da enciclopédia — conteúdo em português (idioma-base).
///
/// Nomes seguem a convenção de cada idioma; enums, elementos e imagens são
/// invariantes. Mantenha a mesma ordem nos três arquivos
/// (`crystals_data_pt/en/es.dart`) — a paridade é verificada em
/// `test/content_parity_test.dart`.
final List<CrystalModel> crystalsPt = [
  const CrystalModel(
    name: 'Ágata',
    description:
