...
/// Arquétipos do caminho mágico — conteúdo em português (idioma-base).
///
/// Emojis e correspondências não textuais são invariantes entre idiomas.
/// Mantenha a mesma ordem nos três arquivos (`archetypes_data_pt/en/es.dart`)
/// — a paridade é verificada em `test/content_parity_test.dart`.
const List<ArcaneEntry> archetypesPt = [
  ArcaneEntry(
    name: 'A Bruxa',
    emoji: '🧙‍♀️',
