/// Significados estáticos dos números (1-9 e mestres 11, 22, 33).
...
const Map<int, NumberMeaning> numberMeanings = {
  1: NumberMeaning(
    number: 1,
    title: 'O Pioneiro',
...
const profileNumberInfos = <String, ProfileNumberInfo>{
...
const Map<String, String> repeatedSequenceMessages = {
