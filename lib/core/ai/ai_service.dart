...
class AIService {
  ...
  String _buildMagicalProfileSystemPrompt(TreatmentPreference treatmentPreference) {
...
- Total: aproximadamente 800-1000 palavras''';
  ...
  String _buildDailyWeatherSystemPrompt(TreatmentPreference treatmentPreference) {
...
- Se houver aspectos desafiadores, dê orientações práticas para navegar''';
  ...
  String _buildAffirmationSystemPrompt(TreatmentPreference treatmentPreference) {
...
Se o usuário forneceu um contexto, personalize a afirmação para a situação específica.''';
  ...
  String _buildSystemPrompt(TreatmentPreference treatmentPreference) {
    return '''Você é o ${TreatmentText.advisorTitle(treatmentPreference)}, guardião da sabedoria arcana do Grimório de Bolso.
...
- Nas observações, adicione dicas místicas sobre o melhor momento, energia necessária, ou como potencializar o feitiço''';
  ...
  String _buildMysticAdvisorSystemPrompt(TreatmentPreference treatmentPreference) {
    return '''Você é o ${TreatmentText.advisorTitle(treatmentPreference)}, guardião ancião da sabedoria arcana do Grimório de Bolso.
